 ...
 */
package me.eccentric_nz.gamemodeinventories.nms;
...
import me.eccentric_nz.gamemodeinventories.api.GameModeInventoriesInventory_api;
import me.eccentric_nz.gamemodeinventories.common.GameModeInventoriesDatabase;
import me.eccentric_nz.gamemodeinventories.common.GameModeInventoriesXPCalculator;
...
public class GameModeInventoriesInventory_v1_4_6 implements GameModeInventoriesInventory_api {
    ...
    public static Inventory fromBase64(String data) {
        ...
        for (int i = 0; i < itemList.size(); i++) {
            ...
            // IsEmpty
            if (!inputObject.d()) {
                inventory.setItem(i, CraftItemStack.asCraftMirror(net.minecraft.server.v1_4_6.ItemStack.a(inputObject)));
            }
        }
        // Serialize that array
        return inventory;
